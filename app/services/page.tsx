      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 text-center z-10">
          ...
          <p className="text-xl md:text-2xl text-white/90 max-w-4xl mx-auto drop-shadow">
            Full selection of transport and trade-related logistics tailored to
            ...
            {services.map((s, i) => (
              <AnimatedSection key={i}>
                <div className="group relative h-full">
                  <div className="absolute -inset-1 bg-linear-to-r from-violet-600/40 to-purple-600/40 rounded-3xl opacity-0 group-hover:opacity-100 transition blur-xl" />
                  <div className="relative h-full bg-zinc-900 border border-violet-900/50 rounded-3xl p-10 hover:border-violet-500 hover:shadow-2xl hover:shadow-violet-600/30 transition-all">
                    <div className="w-20 h-20 rounded-2xl bg-linear-to-br from-violet-600 to-purple-600 p-5 mb-8">
