      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert space-y-8 text-muted-foreground">
          ...
          <p>
            ...
            <strong>ANDAKOR GROUP OÜ</strong> (hereinafter referred to as the
          ...
          <p>
            1.4. The Website of <strong>ANDAKOR GROUP OÜ</strong> is not a mass
            media or trading platform. It is an informational resource of the
            company <strong>ANDAKOR GROUP OÜ</strong>.
          </p>
          <p>
          ...
          <ul>
            <li>
              2.1.1. "Administration" means <strong>ANDAKOR GROUP OÜ</strong>,
          ...
          <ul>
            ...
            <li>
              ...
              <strong>ANDAKOR GROUP OÜ</strong>.
            </li>
          </ul>
          <p>
